...
vim.opt_local.softtabstop = 4 -- number of spaces a <Tab> counts for. When 0, feature is off (sts).
vim.opt_local.textwidth = 180 -- use 180 cols before autoindenting lines on save
