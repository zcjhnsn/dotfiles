...
require('lazy').setup({
  ...
  --
  -- Use `opts = {}` to automatically pass options to a function's `setup()` function, forcing the plugin to be loaded.
  --
  ...
  -- LSP Plugins
  {
    ...
    -- used for completion, annotations of Neovim apis
    'folke/lazydev.nvim',
    ft = 'lua',
    opts = {
      library = {
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'python', 'query', 'rst', 'swift', 'vim', 'vimdoc' },
